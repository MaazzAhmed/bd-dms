                    ...
                    <div class="card border-top border-0 border-4 border-white">
                        ...
                        <div class="card-body p-5">
                            ...
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-white">Edit Lead</h5>
                            ...
                            <form method="post" class="row g-3">
                                ...
                                <div class="col-md-6" id="clientNameField" style="display: none;">
                                    ...
                                    <input type="text" value="<?php echo $leadSourceData['refer_client_name']; ?>" name="RclientName" class="form-control" id="inputFirstName">
                                </div>
                                ...
                                <div class="col-12 text-center">
                                    ...
                                    <button type="submit" name="update_lead" class="btn btn-light px-5">Save Changes</button>
