...
if (!isset($_SESSION['role']) || 
    ($_SESSION['role'] !== 'Admin' && 
    $userPermissions['add_team'] !== 'Allow')) {
	...
	<div class="wrapper">
        ...
        <div class="card border-top border-0 border-4 border-white">
            ...
            <div class="card-body p-5">
                ...
                <div class="card-title d-flex align-items-center">
                    ...
                    <h5 class="mb-0 text-white">Add Team</h5>
                ...
                <form method="post"  class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input  type="text" name="tname"  class="form-control" required id="inputFirstName">
        ...
        ?>
                    ...
                    <div class="col-12 text-center">
                        ...
                        <button type="submit" name="create-team" class="btn btn-light px-5">Create Team</button>
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php echo $_SESSION['Createteam']?? $_SESSION['CreateteamError']; ?>
