...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 23, 2024 at 12:14 PM
...
(8, 'FS1212', 'John William', '+12343455341', '2024-02-10', 'Afghanistan', 'bc230420944mma@vu.edu.pk', 'New', '    dsd', 46),
(9, '6154', 'Sibghat', '1234567890', '2024-02-27', 'Ukraine', 'sibghat@gmail.com', 'Referral', '', 96),
(10, 'dsa', 'sda', '04350450432', '2024-02-28', 'Azerbaijan', 'mf@gmai.com', 'New', '', 46),
(11, 'dmdd42192', 'dawood', '44324323243', '2024-03-19', 'Pakistan', 'dawood@gmail.com', 'New', ' Lorem ipsum dolor sit amet consectetu', 46);
...
(14, 0, 'sadsad', 'Revision', '----', '22333', '100.00', '100.00', 'USD', '123213', 'Meezan', '2024-02-23', '2024-02-23T02:52', '2024-01-23', 'May', 'Paid', 'Team 1', 'Standard', 'Qadama', 2024, 2024, 'ddd', 'Hello There', 46, 8, 'January'),
...
(19, 32432, '432', 'Delivered', 'Full Payment', '50', '1000.00', '110.00', 'BDT', '08764533', 'Meezan', '2024-02-29', '2024-02-28T04:33', '2024-03-13', '', '', 'writers', 'Premium', 'qadamaa', 2022, 2024, '3rrrr', 'ewr few srw', 46, 10, 'March'),
(20, 222, 'Title', 'Converted', 'Half Payment', '1222', '1000.00', '100.00', 'BGN', 'whatsapp', 'Bank 1', '2024-03-20', '2024-03-23T01:56', '2024-03-21', '', '', 'writers', 'Standard', 'AHmed', 2022, 2024, '', 'efw ddfd d ddd dddd ddaaddadadadaddadndadadnda', 46, 3, 'March'),
(22, 4230, 'Title', 'Converted', 'Half Payment', '50', '1000.00', '100.00', 'AZN', '08764533', 'HBL', '2024-03-20', '2024-03-20T03:04', '2024-03-20', 'April', 'Paid', 'writers', 'GOld', 'assignmed', 2020, 2020, 'assignmed', 'FEWQF DFDSFCDS', 46, 4, 'March'),
(39, 222, 'Title', 'Revision', 'Half Payment', '1222', '1000.00', '100.00', 'AED', '08764533', 'HBL', '2024-03-24', '2024-03-29T03:40', '2024-03-20', 'March', 'Paid', 'writers', 'Premium', 'assignmed', 2024, 2023, 'Check Comments', 'ew ewr fdsf efwr ', 46, 11, 'March');
...
(68, 'Allow', 'Allow', 'Allow', 'Allow', 'Allow', 'Allow', 'Allow', 'Allow', 'Allow', 'Allow', 'Allow', 'Allow', 'Allow', 'Allow', 46),
(69, 'Deny', 'Deny', 'Allow', 'Deny', 'Allow', 'Deny', 'Deny', 'Deny', 'Deny', 'Deny', 'Deny', 'Deny', 'Deny', 'Deny', 47);
...
(46, 'admin', 'admin@gmail.com', '$2y$10$L1vUIr.YSjVW.58zCdnjguCGGlXvNMNUm4/tLvasK7gDjfPdn4SSy', 'Admin', '2024-03-21 14:26:34', '::1', 2, 14, 'Active', '123'),
(47, 'editors', 'editors@gmail.com', '$2y$10$nD9fFaa1EOuo75WUBkSzCuBhMT0gs6z/Ae.w51jr60/HNHn6QuToK', 'Editor', '2024-02-26 16:51:44', '39.51.69.16', 8, 14, 'Active', '123'),
...
(97, 'Maaz', 'maaza42101@gmail.com', '$2y$10$A/unfoK6SHS0KzuDvjL9zOvlN0baypL.H07.3Tjnhours8msvyYXi', 'Admin', NULL, NULL, 2, 14, 'Active', '123');
...
--
ALTER TABLE `permissions`
  MODIFY `permissionid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
...
--
ALTER TABLE `leads`
  ADD CONSTRAINT `leads_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`userId`);
...
--
ALTER TABLE `team`
  ADD CONSTRAINT `fk_team_lead_user` FOREIGN KEY (`team_lead`) REFERENCES `user` (`userId`) ON DELETE SET NULL ON UPDATE CASCADE;
