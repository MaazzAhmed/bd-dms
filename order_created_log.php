        ...
        <div class="card border-top border-0 border-4 border-white">
            ...
            <div class="card-body p-5">
                ...
                <div class="card-title d-flex align-items-center">
                    ...
                    <h5 class="mb-0 text-white">Order Created Logs</h5>
...
$logFile = 'logs/order_created_log.txt';
...
if (file_exists($logFile)) {
    ...
    foreach ($logRecords as $logRecord) {
        ...
        if (count($logParts) == 2) {
            ...
            $formattedDate = DateTime::createFromFormat('Y-m-d H:i:s', trim($logParts[0]))->format('M d, Y h:i a');
