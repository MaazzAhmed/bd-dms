...
<script>
    $(document).ready(function() {
        ...
        // Callback for the daterange selection
        function cb(start, end) {
            $('#reportrange #pick').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
            loadAnalyticsData();
        }

        // Initially load the data with the default date range
        cb(start, end);

        // Listen for date range selection change
        ...
        function toggleResetButton() {
            ...
            if (hasActiveFilters) {
                $('#resetFiltersBtn').fadeIn();
            } else {
                $('#resetFiltersBtn').fadeOut();
            }
        }
        ...
        function getFilterValues() {
            ...
            return {
                ...
                startDate: dateRange ? dateRange.startDate.format('YYYY-MM-DD') : null,
                endDate: dateRange ? dateRange.endDate.format('YYYY-MM-DD') : null,
            };
        }
