<?php $TITLE = "Email Template 3"; ?>
<?php $file_name = "checkemail-setting" ?>
...
<div class="wrapper">
    ...
    $results = mysqli_query($conn, "SELECT description FROM email_setting WHERE file_name = '$file_name'");
                    ...
                    <div class="card border-top border-0 border-4 border-white">
                        ...
                        <div class="card-body p-5">
                            ...
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-white">Template 3</h5>
                            ...
                            <form method="post" enctype="multipart/form-data" class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="file" name="attachment[]" multiple class="form-control" required id="inputEmail">
                                </div>
                                <div class="col-12 text-center">
                                    <button type="submit" name="submittemplate3" class="btn btn-light px-5">Send Email</button>
                                </div>
                            </form>
                        </div>
                    </div>
