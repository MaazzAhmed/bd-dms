...
$results = mysqli_query($conn, "SELECT description FROM email_setting where id=2");
                    ...
                    <div class="card border-top border-0 border-4 border-white">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-white">Email Template 2</h5>
                            </div>
                            <hr>
                            <form method="post" enctype="multipart/form-data" class="row g-3">
                                <div class="col-md-6">
                                    <label for="inputFirstName" class="form-label">Main Title</label>
                                    <input type="text" name="main_title" name="main_title" class="form-control" required id="inputFirstName">
                                </div>
                                <div class="col-md-6">
                                    <label for="inputEmail" class="form-label">Subject</label>
                                    <input type="text" name="subject" class="form-control" required id="inputEmail">
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="file" name="attachment[]" multiple class="form-control" required id="inputEmail" placeholder="All Employees">
                                </div>
