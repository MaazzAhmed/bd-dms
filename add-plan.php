        ...
        <div class="card border-top border-0 border-4 border-white">
            ...
            <div class="card-body p-5">
                ...
                <div class="card-title d-flex align-items-center">
                    ...
                    <h5 class="mb-0 text-white">Add Plan</h5>
                ...
                <form method="post"  class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <label for="inputFirstName" class="form-label">Plan</label>

                        <input  type="text" name="plan"  class="form-control" required id="inputFirstName">

                    </div>

                    <div class="col-12 ">

                        <button type="submit" name="create_plan" class="btn btn-light px-5">Add</button>
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php echo $_SESSION['Createplan']?? $_SESSION['CreatePlanError']; ?>
