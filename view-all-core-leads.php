...
<div class="wrapper">
    ...
    if (isset($_POST['view-all-core-leads'])) {

        $leadid = $_POST['allleadid'];

        $leads = getDetailsForSelectedcoreleads($conn, $leadid);
                            ...
                            <div class="card border-top border-0 border-4 border-white">
                                ...
                                <div class="card-body p-5">
                                    ...
                                    <div class="card-title d-flex align-items-center">
                                        ...
                                        <h5 class="mb-0 text-white">Core Leads Detail</h5>
