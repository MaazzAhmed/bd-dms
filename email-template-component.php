...
<div class="wrapper">
    ...
    $file_name = trim($file_name); // Remove any extra spaces

    $results = mysqli_query($conn, "SELECT id, description, brandname FROM email_setting WHERE file_name = '$file_name'");
                    ...
                    <div class="card border-top border-0 border-4 border-white">
                        ...
                        <div class="card-body p-5">
                            ...
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-white"><?php  echo $brandname?> Template</h5>
                            ...
                            <form method="post" enctype="multipart/form-data" class="row g-3">
                                ...
                                <input type="hidden" name="email-setting-id" value="<?php echo $id ?>">
